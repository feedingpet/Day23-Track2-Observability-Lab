...
def main() -> int:
    ...
    try:
        ...
        print("evidently not installed; skipping HTML report. Install with: python -m pip install evidently")
    except Exception as e:
        print(f"evidently installed but failed to generate HTML report ({type(e).__name__}: {e})")
    return 0
